...
#include "stdafx.h"
#include "spitoniccontrolswitchersynthvoroguiwin32.h"
#include "FreeImage.h"
...
//static ControlSnapToScaleExpSynth synth;
...
TCHAR szTitle[1024]={L"spitoniccontrolswitchersynthvoroguiwin32title"};					// The title bar text
TCHAR szWindowClass[1024]={L"spitoniccontrolswitchersynthvoroguiwin32class"};				// the main window class name
